...
import Project_Profile from '../assets/project.png';
                    ...
                    project.map((data) => (
                        <>
                            <div className="w-full overflow-hidden shadow-lg bg-[#232a34] pb-4 card_glow border border-[#1484da]" key={data.id}>
                                ...
                                <p className='text-white py-5 px-5 pl-5'><span className='text-[#1484da] font-bold text-[14px]'>Technologies: </span>{data.technologies}</p>

                                <div className='flex gap-4 justify-center'>
                                    <a href={data.demo} className='px-[20px] py-[5px] w-[100px] rounded mt-6 border border-[#1484da] transition-all duration-700 ease-in-out hover:bg-[#1484da]'>Demo</a>
                                    <a href={data.source} className='px-[20px] py-[5px] w-[100px] rounded mt-6 bg-[#1484da] transition-all duration-700 ease-in-out hover:bg-transparent border border-[#1484da] '><a href='https://www.youtube.com/watch?v=cWYKs1pu6s4&t=135s' target='_blank'>Code</a></a>
